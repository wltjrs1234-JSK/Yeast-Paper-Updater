...
이 프로젝트는 매주 월요일 자동으로 S. cerevisiae(효모)와 관련된 지난 7일간의 최신 연구 문헌(논문, 프리프린트 등)을 검색하여 이메일로 전송해주는 파이프라인입니다.
...
---
성공적으로 설정되었다면, 매주 월요일 오전 9시(한국시간 기준)에 지난 7일 동안 새롭게 등록된 문헌들이 요약본(Abstract) 및 링크와 함께 이메일로 자동 전송됩니다.
